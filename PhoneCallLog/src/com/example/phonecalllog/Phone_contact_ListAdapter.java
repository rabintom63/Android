...
import com.example.phonecalllog.Image.SmartImageView;
...
public class Phone_contact_ListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.contact_cell, null);
        }
        ...
        TextView  useremail=(TextView)convertView.findViewById(R.id.phone_number);
